...
- **Умный разбор задач** — пишешь задачу обычным текстом, бот сам разбирается что это: простая задача, встреча или проект
...
- **Удаление, завершение и редактирование** задач голосом: "удали задачу купить хлеб"
