...
const INTENT_KEYWORDS: Record<string, string[]> = {
  ...
  today:    ["задачи на сегодня", "что на сегодня", "сегодняшние задачи", "задачи сегодня", "покажи сегодня", "что сегодня"],
  week:     ["задачи на неделю", "что на неделе", "задачи на этой неделе", "недельные задачи", "покажи неделю", "что на этой неделе"],
};
